...
- Create a root `.gitignore` that excludes `node_modules/`, Python virtual environments (`.venv/`, `venv/`, `env/`, `__pypackages__/`), `dist/`, `build/`, `.env`, `.env.*`, coverage, caches, logs, and OS/editor files while allowing `.env.example`.
